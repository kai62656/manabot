...
static KeyData const keyData[KeyboardConfig::KEY_TOTAL] = {
    ...
    {"keyBot", SDLK_k, _("Bot")},
    {"keyHeal", SDLK_h, _("Heal / Heal Target")},
    {"keyArrow", SDLK_d, _("Arrow Rain")},
    {"keyLightning", SDLK_e, _("Lightning")},
    {"keyAggro", SDLK_y, _("itenplz")},
    {"keyDwalkup", SDLK_l, _("Drunk walk up")},
    {"keyDwalkdown", SDLK_p, _("Drunk walk down")},
    {"keyDwalkright", SDLK_o, _("Drunk walk right")},
    {"keyDwalkleft", SDLK_i, _("Drunk walk left")},
    {"keySpamemote", SDLK_n, _("Spam emote")},
    {"keyLifestones", SDLK_m, _("Life Stones")},
    {"keyGreet", SDLK_m, _("Greeting")},
    {"keyBye", SDLK_m, _("Goodbye")},
    {"keyTaunts", SDLK_m, _("Taunts")},
    {"keyThanks", SDLK_m, _("Thanks")},
    {"keyMk", SDLK_m, _("Mortal Kombat")},
    ...
    {"keyAutoPickup", SDLK_g, _("Auto Pickup")},
    {"keyFollow", SDLK_c, _("Follow Player")},
    {"keyFast", SDLK_y, _("Fast Actions")},
    {"keyHideWindows", SDLK_h, _("Hide Windows")},
    {"keyBeingSit", SDLK_s, _("Sit")},
    {"keyBeingSit2", SDLK_w, _("Direction Sit")},
